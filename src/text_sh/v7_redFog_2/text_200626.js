...
function keydown(e) {
	...
	if ((e.keyCode >= 65) && (e.keyCode <=90)){
		...
		var rect = new createjs.Shape();
		rect.graphics.beginFill("red").drawRect(0, 0, char_space/5,300);
		...
		createjs.Tween.get(rect, { loop: false , bounce: true})
  		.to({ scaleX:char_space }, 500, createjs.Ease.getPowInOut(4))
  		.wait(500)
  		.to({ scaleX:1 }, 1000, createjs.Ease.getPowInOut(4))
